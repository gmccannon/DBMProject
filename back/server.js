...
// CORS Configuration
const CORS_ORIGIN = 'http://localhost:3000'; // Replace with your frontend's URL
...
app.get('/ind', (req, res) => {
    try {
        ...
        const mediaItems = db.prepare(sql).all(id); // Safely pass the id as a parameter

        console.log('Query result:', mediaItems); // Log the result
